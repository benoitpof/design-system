...
Exemples produits de type **social**. Chaque exemple suit le format :

```
examples/social/<asset-id>/
...
Les exemples `golden` (max 5 par type, rotation hard) sont en plus dans `/golden/social/`.
